...
public:
     ...
     * @brief 发布仿真特征点数据
     * 
     * @param dStampSec： 图像帧时戳 
     * @param feature_ids ： 所有特征点的id
     * @param cur_un_pts ：所有特征点的归一化坐标
     * @param cur_pts ：所有特征点的像素坐标
     * @param cur_velocity ：所有特征点的归一化像面速度
     */
    void PubSimFeature(double dStampSec, const vector<int> &pt_ids, const vector<Vector2d> &cur_un_pts,
